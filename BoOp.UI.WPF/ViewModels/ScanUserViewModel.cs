...
namespace BoOp.UI.WPF.ViewModels
{
    ...
    public class ScanUserViewModel : ViewModel
    {
        ...
        public ScanUserViewModel(INavigationService navigationService, ILibrary library, Dispatcher dispatcher)
        {
            ...
            {
                //standard benutzer
                _library.AddUser(new PersonModel{AusweisID = "RickSanchez", Klassenname="Admin",Vorname = "Admin", Nachname = "Admin", GeburtsdatumString = new DateTime(1111, 11, 11).ToString("d"), Telefonnummer="00", Rechte = Rechtelevel.ADMIN, EMail="00", PasswortHash= "C71FC1B21A6824082BB07D3BF6695D4737D8691B57CEB34E592A8BDE11CB4EA3" });
            }
